...
import testRagSearchRoutes from './routes/testRagSearch';
import searchPublicRoutes from './routes/search-public';
import performanceRoutes, { performanceMiddleware } from './routes/performance';
 ...
 * Rate Limiting
 */
// TYMCZASOWO WYŁĄCZONE NA CZAS KODOWANIA
...
// Performance monitoring middleware (after API routes)
...
apiRouter.use('/real-vector-search', realVectorSearchRoutes);
