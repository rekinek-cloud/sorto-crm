...
import testCommunicationsRoutes from './routes/test-communications';
import gtdInboxRoutes from './routes/gtdInbox';
import smartMailboxesRoutes from './routes/smartMailboxes';
import voiceRoutes from './routes/voice-simple';
// import voiceRagRoutes from './routes/voice-rag';
import searchRoutes from './routes/search';
import searchPublicRoutes from './routes/search-public';
...
apiRouter.use('/gtd-inbox', gtdInboxRoutes);
// apiRouter.use('/modern-email', modernEmailRoutes);
...
apiRouter.use('/ai-v2', aiV2Routes);
apiRouter.use('/admin/ai-config', aiConfigRoutes);
apiRouter.use('/universal-rules', universalRulesRoutes);
apiRouter.use('/ai-rules', aiRulesRoutes);
apiRouter.use('/auto-replies', autoRepliesRoutes);
apiRouter.use('/ai-insights', aiInsightsRoutes);
apiRouter.use('/unified-rules', unifiedRulesRoutes);
apiRouter.use('/ai-knowledge', aiKnowledgeRoutes);
...
apiRouter.use('/test-communications', testCommunicationsRoutes);
apiRouter.use('/smart-mailboxes', smartMailboxesRoutes);
apiRouter.use('/voice', voiceRoutes);
// apiRouter.use('/voice/rag', voiceRagRoutes);
apiRouter.use('/search', searchRoutes);
apiRouter.use('/search-public', searchPublicRoutes);
