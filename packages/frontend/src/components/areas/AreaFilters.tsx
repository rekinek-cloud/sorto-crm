...
import { AreaFilters } from '@/lib/api/areas';
...
export default function AreaFiltersComponent({ 
  filters, 
  onFiltersChange 
}: AreaFiltersProps) {
  
  const handleFilterChange = (key: keyof AreaFilters, value: any) => {
    onFiltersChange({
      ...filters,
      [key]: value,
        ...
        <div>
          ...
          <div className="flex space-x-2">
            ...
            >
              ...
              <option value="reviewFrequency">Review Frequency</option>
            </select>
            <select
