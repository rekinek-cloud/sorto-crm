...
interface WeeklyReviewSprintItem {
  ...
  gtdPhase: 'CLARIFY' | 'ORGANIZE' | 'REFLECT' | 'ENGAGE';
...
export default function WeeklyReviewScrumPage() {
  ...
  const [newItem, setNewItem] = useState({
    title: '',
    description: '',
    gtdCategory: 'COLLECT' as 'PROCESS' | 'COLLECT' | 'ORGANIZE' | 'REFLECT' | 'ENGAGE',
    gtdPhase: 'CLARIFY' as 'ORGANIZE' | 'REFLECT' | 'ENGAGE' | 'CLARIFY',
    itemType: 'TASK' as 'TASK' | 'PROJECT' | 'REFERENCE' | 'AREA' | 'CONTEXT' | 'SOMEDAY_MAYBE',
    priority: 'MEDIUM' as 'HIGH' | 'MEDIUM' | 'LOW' | 'URGENT',
    energy: 'MEDIUM' as 'HIGH' | 'MEDIUM' | 'LOW' | 'CREATIVE',
    context: '@computer',
    estimatedTime: 30,
